...
export default function CreatePersonalRoutineScreen() {
  ...
  const handleCreate = async () => {
    ...
    setLoading(true);
    try {
      await routinesService.createPersonalRoutine({
        title: title.trim(),
  ...
  return (
    <KeyboardAvoidingView style={styles.container} behavior={Platform.OS === 'ios' ? 'padding' : 'height'}>
      <ScrollView contentContainerStyle={styles.inner}>
        ...
        <Text style={styles.title}>Новое личное задание</Text>
        <Text style={styles.subtitle}>Будет появляться у тебя каждый день. Тренер сможет видеть прогресс</Text>
